...
parenExpr (Atomic (Paren (Atomic (Paren e))))  = parenExpr e
parenExpr (Atomic (Paren (Atomic (Var x))))    = Atomic (Var x)
parenExpr (Atomic (Paren (Atomic (Num x))))    = Atomic (Num x)
parenExpr (Atomic (Paren (Atomic (Pack x y)))) = Atomic (Pack x y)
parenExpr e               = e
